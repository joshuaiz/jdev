	...
	<body <?php body_class(); ?>>
		...
		<div class="header-background">
			...
			<?php $url = content_url(); ?>
				...
				<?php } elseif (in_category( 'jockey-sport' ) || is_page(242) ) { ?>
